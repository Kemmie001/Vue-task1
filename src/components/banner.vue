    ...
    <section class="">
       <article class="grid my-2">
        ...
        <aside class="col-2">
          ...
          <button class="btn">
            <a class="link" href=""><i class="fab fa-twitter"></i>
            Share on Twitter
            </a>
          </button>
          <button class="btn">
            <a class="link" href=""><i class="fab fa-linkedin-in"></i>
            Share on LinkedIn
            </a>
          </button>
          <div class="job">
...
<style scoped>
  ...
  .green-btn{
    ...
    margin-top: 0.5rem;
    width: 90%;
    /* box-shadow:hsla(0, 4%, 91%, 0.7) 1px 1px 1px 1px; */
    border: none;
    border-radius: 0.3rem;
    text-align: center;
    font-weight: bold;
  ...
  .btn{
    ...
    margin-top: 1rem;
    width: 90%;
    box-shadow:hsla(0, 4%, 73%, 0.7) 1px 1px 1px 1px;
    border: none;
    border-radius: 0.3rem;
  }
  .fab{
